...
def main():
    ...
    while True:
        ...
        if frame_count >= FIXED_FRAMES:
            ...
            if top1_confidence[0] > 0.4:
                print(f"{GREEN}Top 1 Prediction: {top1_label[0]} (Confidence: {top1_confidence[0]:.2f}){RESET}")
                print(f"{RED}Top 2 Prediction: {top2_label[0]} (Confidence: {top2_confidence[0]:.2f}){RESET}")
